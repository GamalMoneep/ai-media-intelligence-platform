...
class Transcriber:
    ...
    def transcribe(self, audio_path: Path) -> Optional[Dict]:
        ...
        try:
            ...
            # Debug: Check if the audio file is readable
            ...
            try:
                # Debug: Log before transcription
                print(f"Attempting transcription with path: {str(audio_path)}")

                modelAPI = whisper.load_model("tiny")

                # Try the newer API
                result = modelAPI.transcribe(str(audio_path))

                # Debug: Log after transcription
                print(f"Transcription successful. Result: {result}")
                ...
                print(f"Fallback transcription successful. Result: {result}")
