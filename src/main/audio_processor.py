...
class AudioProcessor:
    ...
    def get_audio_path(self, episode: PodcastFetcher) -> Path:
    ...
    def download_episode(self, episode: PodcastFetcher) -> Optional[Path]:
    ...
    def download_episodes(self, episodes: list[PodcastFetcher]) -> list[Path]:
